# Claude Code Guidelines — domus

App de gestión doméstica/familiar (backend Node + frontend, Docker). Incluye análisis de emails con IA y calendario.
...
2. Revisar `/root/apps/wiki/projects/domus/overview.md` si existe.

Conocimiento acumulado de este proyecto en `/root/apps/wiki/projects/domus/`.
